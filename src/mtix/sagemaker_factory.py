...
def create_descriptor_prediction_pipeline(desc_name_lookup_path, dui_lookup_path, cnn_endpoint_name, pointwise_endpoint_name, listwise_endpoint_name, bucket_name, cnn_batch_size=128, pointwise_batch_size=128, listwise_batch_size=128):
    ...
    tensorflow_endpoint = TensorflowAsyncEndpoint(sagemaker_async_tf_endpoint, "cnn_endpoint", bucket_name)
    ...
    pointwise_hf_endpoint = HuggingFaceAsyncEndpoint(pointwise_sagemaker_async_hf_endpoint, "pointwise_endpoint", bucket_name)
    ...
    listwise_hf_endpoint = HuggingFaceAsyncEndpoint(listwise_sagemaker_async_hf_endpoint, "listwise_endpoint", bucket_name)
