...
HUGGINGFACE_PREDICTOR_POINTWISE_RESULT_1 = [
...
HUGGINGFACE_PREDICTOR_POINTWISE_RESULT_2 = [
    ...
    def test_predict(self):
        ...
        def mock_predict(data):
            if data == HUGGINGFACE_PREDICTOR_EXPECTED_POINTWISE_INPUT_DATA_1:
                return HUGGINGFACE_PREDICTOR_POINTWISE_RESULT_1
            elif data == HUGGINGFACE_PREDICTOR_EXPECTED_POINTWISE_INPUT_DATA_2:
                return HUGGINGFACE_PREDICTOR_POINTWISE_RESULT_2
            else:
